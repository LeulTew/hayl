...
const EXERCISES = [
  ...
  { name: "Goblet Squat", muscleGroup: "Legs", instructions: "Hold dumbbell at chest. Squat deep with elbows inside knees. Drive through heels. Maintain upright torso throughout." },
